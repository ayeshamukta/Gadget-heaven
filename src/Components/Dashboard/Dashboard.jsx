...
const Dashboard = () => {
    ...
    // const [btnCol,setBtnCol] = useState(null);
                ...
                <TabPanel>
                    <div className='flex justify-between font-bold text-xl mt-8 items-center'>
                        ...
                        <div className='flex gap-5 items-center'>
                            ...
                            <button className='btn rounded-full border text-lg border-[#8332C5] text-[#9538E2] font-bold'>Purchase</button>
                        </div>
                    </div>
